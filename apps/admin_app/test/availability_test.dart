...
import 'package:auto_skola_365_admin_app/src/features/availability/domain/entities/availability.dart';
import 'package:auto_skola_365_admin_app/src/features/availability/domain/repositories/availability_repository.dart';
import 'package:auto_skola_365_admin_app/src/features/availability/domain/usecases/manage_availability.dart';
import 'package:auto_skola_365_admin_app/src/features/availability/presentation/cubit/availability_cubit.dart';
import 'package:auto_skola_365_admin_app/src/features/availability/presentation/pages/availability_view.dart';
...
void main() {
  ...
  test(
    ...
    () async {
      final c = make(repo);
      await c.load();
      final old = Completer<Result<Availability>>();
      repo.loading = () => old.future;
      final load = c.load();
      final pending = Completer<Result<Availability>>();
